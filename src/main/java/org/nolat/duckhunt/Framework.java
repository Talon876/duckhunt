...
public class Framework extends Canvas {
    ...
    private void drawMainMenu(Graphics2D g2d) {
        ...
        g2d.drawString("Shoot with left click", frameWidth / 2 - 100, (int) (frameHeight * 0.65));
        g2d.drawString("Start with left click", frameWidth / 2 - 100, (int) (frameHeight * 0.68));
        g2d.drawString("Press ESC any time to exit the game.", frameWidth / 2 - 100, (int) (frameHeight * 0.71));
        g2d.drawString("Headshots are worth extra points.", frameWidth / 2 - 100, (int) (frameHeight * 0.74));
        g2d.drawString("Play until 15 ducks escape.", frameWidth / 2 - 100, (int) (frameHeight * 0.77));
        g2d.setColor(Color.white);
    }
